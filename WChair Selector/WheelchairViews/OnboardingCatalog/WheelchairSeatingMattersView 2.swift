//
//  WheelchairSeatingMattersView.swift
//  Seating App
//
...
struct WheelchairSeatingMattersView: View {
...
//           .shadow(radius: 8, x: 3, y: 3)
           ...
           .sheet(isPresented: self.$showSheet) {
              WheelchairDetailView(wheelchair: wheelchairData[5])
...
struct WheelchairSeatingMattersView_Previews: PreviewProvider {
